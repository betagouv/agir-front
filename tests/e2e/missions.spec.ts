                      ...
                      data: [
                        {
                          ...
                          attributes: {
                            ...
                            formats: {
                              large: {
                                ext: '.webp',
                                url: 'https://res.cloudinary.com/dq023imd8/image/upload/v1701947358/large_Logo_Ademe_2020_c234624ba3.webp',
                                hash: 'large_Logo_Ademe_2020_c234624ba3',
                                mime: 'image/jpeg',
                                name: 'large_Logo-Ademe-2020.webp',
                                path: null,
                                size: 57.44,
                                width: 877,
                                height: 1000,
                              ...
                              small: {
                                ext: '.webp',
                                url: 'https://res.cloudinary.com/dq023imd8/image/upload/v1701947358/small_Logo_Ademe_2020_c234624ba3.webp',
                                hash: 'small_Logo_Ademe_2020_c234624ba3',
                                mime: 'image/jpeg',
                                name: 'small_Logo-Ademe-2020.webp',
                                path: null,
                                size: 24.62,
                                width: 438,
                                height: 500,
                              ...
                              medium: {
                                ext: '.webp',
                                url: 'https://res.cloudinary.com/dq023imd8/image/upload/v1701947358/medium_Logo_Ademe_2020_c234624ba3.webp',
                                hash: 'medium_Logo_Ademe_2020_c234624ba3',
                                mime: 'image/jpeg',
                                name: 'medium_Logo-Ademe-2020.webp',
                                path: null,
                                size: 41.02,
                                width: 657,
                                height: 750,
                              ...
                              thumbnail: {
                                ext: '.webp',
                                url: 'https://res.cloudinary.com/dq023imd8/image/upload/t_media_lib_thumb/v1701947358/Logo_Ademe_2020_c234624ba3.webp',
                            ...
                            mime: 'image/jpeg',
                            size: 55.75,
                            url: 'https://res.cloudinary.com/dq023imd8/image/upload/v1701947358/Logo_Ademe_2020_c234624ba3.webp',
                            previewUrl: null,
                            provider: 'cloudinary',
    ...
    await page.route(`${process.env.VITE_API_URL}/utilisateurs/dorian/bibliotheque/articles/111`, route => {
      route.fulfill({
        ...
        body: JSON.stringify({
          ...
          image_url:
            'https://res.cloudinary.com/dq023imd8/image/upload/t_media_lib_thumb/v1701356429/suheyl_burak_BJ_Xi_Srr_Cv_A8_unsplash_5540d2d276.webp',
          points: 5,
          favoris: false,
