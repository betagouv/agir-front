    ...
    return Promise.resolve({
      ...
      électrique: [
        ...
        },
        {
          ...
          description: "La ville de Paris subventionne l’achat d’un vélo électrique à hauteur de 33% et\njusqu’à un plafond de 400 €.\n",
      ...
      cargo: [
        ...
        {
          libelle: "Ville de Paris",
          description: "La ville de Paris subventionne l’achat d’un vélo cargo à hauteur de 33% et\njusqu’à un plafond de 600 €.\n",
          lien: "https://www.paris.fr/pages/lutte-contre-la-pollution-les-aides-a-la-mobilite-5373",
          collectivite: {
            kind: "code insee",
            value: "75056",
      ...
      "cargo électrique": [
        ...
        {
          libelle: "Ville de Paris",
          description: "La ville de Paris subventionne l’achat d’un vélo cargo électrique à hauteur de 33% et\njusqu’à un plafond de 600 €.\n",
          lien: "https://www.paris.fr/pages/lutte-contre-la-pollution-les-aides-a-la-mobilite-5373",
          collectivite: {
            kind: "code insee",
            value: "75056",
      ...
      motorisation: [
        ...
        {
          libelle: "Ville de Paris",
          description: "La ville de Paris subventionne l’achat d’un kit de motorisation à hauteur de 33% et\njusqu’à un plafond de 400 €.\n",
          lien: "https://www.paris.fr/pages/lutte-contre-la-pollution-les-aides-a-la-mobilite-5373",
          collectivite: {
            kind: "code insee",
            value: "75056",
...
describe("Fichier de tests pour simuler une aide velo", () => {
  it("En donnant un code postal et un revenu fiscal de référence doit me retourner une liste d'aide", async () => {
    // GIVEN
    // WHEN
    const useCase = new SimulerAideVeloUsecase(new SimulerAideRetrofitRepositoryForTest());
