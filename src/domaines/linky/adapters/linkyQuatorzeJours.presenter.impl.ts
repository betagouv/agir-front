import { ConsommationElectriqueViewModel, LinkyPresenter } from '@/domaines/linky/ports/linky.presenter';
import { ConsommationElectrique } from '@/domaines/linky/ports/linkyRepository.repository';
