<template>
  <div class="action fr-my-1w">
    <h1 class="action__titre text--normal" v-html="actionBaseViewModel.titre" />
    <p v-if="actionBaseViewModel.sousTitre" class="fr-text--lg" v-html="actionBaseViewModel.sousTitre" />
