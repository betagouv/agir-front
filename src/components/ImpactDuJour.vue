<template>
  <aside class="background-bleu text--white fr-p-3w">
    <h2 class="fr-h5 text--white fr-mb-2w">Impact du jour</h2>
    <p class="fr-mb-2w">
      <span class="text--3xl fr-text--bold">{{ consommationDuJour }}</span>
      <span class="fr-text--bold"> kg </span>
      de CO₂-e
    </p>
