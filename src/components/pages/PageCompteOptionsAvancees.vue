<template>
  <CompteSkeleton page-courante="Mon Compte - Options avancées">
    ...
    <div class="fr-p-2w fr-mb-2w text-warning border--warning">
      ...
      <button
        class="fr-btn fr-btn--sm fr-btn--icon-left fr-icon-warning-line text-warning border--warning background--white"
...
<script setup lang="ts">
  ...
  import CompteFormulaireMotDePasse from '@/components/custom/Compte/CompteFormulaireMotDePasse.vue';
