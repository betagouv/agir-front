<template>
  <div>
    <button class="fr-btn fr-background-action-high--red-marianne" data-fr-opened="false" aria-controls="fr-modal-2">
      Supprimer le compte
    </button>
            ...
            <div class="fr-modal__body">
              ...
              <div class="fr-modal__footer">
                ...
                >
                  ...
                  <li>
                    <button class="fr-btn fr-icon-checkbox-line fr-btn--secondary" aria-controls="fr-modal-2">
                      Annuler
                    </button>
                  </li>
                </ul>
