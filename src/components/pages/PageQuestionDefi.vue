<template>
  <div class="fr-container fr-mb-6w">
    ...
    <div class="fr-grid-row fr-grid-row--gutters" v-else-if="!isLoading && defiViewModel">
      <div class="background--white fr-col-8 border fr-p-4w border-radius--md">
        <span class="display-block fr-mb-2w fr-mr-1w fr-tag background-bleu text--white">Action</span>
        <span class="display-block fr-text--bold fr-mb-1w fr-text--sm text--black">{{ defiViewModel.thematique }}</span>
