  ...
  >
    ...
    <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
      <div class="fr-input-group">
        ...
        <input id="date-default-1578-bday-day" v-model="birthdate.jour" class="fr-input" name="day" type="text" />
      </div>
    </div>
    <div class="fr-fieldset__element fr-fieldset__element--inline fr-fieldset__element--number">
      <div class="fr-input-group">
        ...
        <input id="date-default-1578-bday-month" v-model="birthdate.mois" class="fr-input" name="month" type="text" />
      </div>
    </div>
    <div
    ...
    >
      <div class="fr-input-group">
        ...
        <input id="date-default-1578-bday-year" v-model="birthdate.annee" class="fr-input" name="year" type="text" />
      </div>
    </div>
